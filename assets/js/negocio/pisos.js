                ...
                $.each(arr, function (index, contenido) {
                    ...
                    if (contenido.bloque == dato) {
                        if (contenido.idSala != sala) {
                            ...
                            bloque = bloque.toLowerCase();
                            aux = 1;
                            estado = (contenido.estado == 1) ? "<p style = 'font-weight: 500;font-weight: bold;color : green;font-size:30px;'>CAMA LIBRE</p>" :( (contenido.estado == 2) ? "<p style = 'font-size:25px;font-weight: 800; color : red;'>CAMA OCUPADA</p>":"<p style = 'font-size:25px;font-weight: 800; color : #FFDE2B;'>PACIENTE AISLADO</p>");
