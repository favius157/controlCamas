...
window.ParsleyConfig.i18n.en = $.extend(window.ParsleyConfig.i18n.en || {}, {
  defaultMessage: "El valor ingresado no es valido",
  type: {
    email:        "Ingrese un email valido",
    url:          "Ingrese una URL valida",
    number:       "Ingrese valores numericos",
    integer:      "Ingrese solo valores enteros",
  ...
  min:            "El texto tiene que tener %s o mas caracteres.",
  max:            "This value should be lower than or equal to %s.",
  range:          "This value should be between %s and %s.",
  minlength:      "El texto ingresado es muy corto. El texto debe tener %s caracteres o mas",
  maxlength:      "El texto ingresado es muy largo. El texto debe tener %s caracteres o menos",
  length:         "La cantidad de caracteres es invalida. Ingrese entre %s y %s caracteres.",
  mincheck:       "You must select at least %s choices.",
  maxcheck:       "You must select %s choices or less.",
  check:          "You must select between %s and %s choices.",
  equalto:        "Los valores ingresados en la clave tienen que ser iguales"
});
